      ...
      {r.credential ? (
        ...
        <div className="field">
          ...
          <input
            ...
            onChange={async (e) => {
              ...
              try {
                ...
                r.setCredential(importCredential(await file.text()));
                r.notify('Credential imported locally.');
              } catch {
                r.setCredential(null);
                setError(
                  'Invalid credential. Use a valid version 1 JSON file, up to 16 KB.',
                );
              } finally {
                input.value = '';
                setBusy(false);
          ...
          <small>
            {busy
              ? 'Validating locally...'
              : 'Your file stays on this device. It is never uploaded to the application server.'}
          </small>
        </div>
      )}
